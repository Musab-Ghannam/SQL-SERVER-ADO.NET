<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="CategoryPage.Category" %>
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://localhost:44354/Product.aspx">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost:60399/Users.aspx">
    ...
    <form id="form1" runat="server">
        <h6><a href='Create.aspx'>Create New</a></h6>
